...
import Add_Care_Dep_Container from '../Pages_Main_Components/Pages_Main_Container/Add_Care_Dep_Container';
export default function care_department_info()
{
    return (
...
care_department_info.getLayout = getLayout