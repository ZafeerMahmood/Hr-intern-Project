...
import Add_Care_Project_Emp_Container from '../Pages_Main_Components/Pages_Main_Container/Add_Care_Project_Emp_Container';
export default function care_project_emp()
{
    return (
       ...
       <Add_Care_Project_Emp_Container/>
...
care_project_emp.getLayout = getLayout