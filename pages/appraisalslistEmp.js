...
import { getLayout } from '../layout/EmpLayout';

export default function AppraisalLists({ appraisals }) {
  return (
    <div className='w-full h-full overflow-auto bg-white '>
    <div className=' flex flex-col  items-start justify-start  w-full h-screen p-10  border-t-0 border-black border-l-0 border-[1px]'>
