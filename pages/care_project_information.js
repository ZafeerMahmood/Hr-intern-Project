...
import Add_Care_Project_Container from '../Pages_Main_Components/Pages_Main_Container/Add_Care_Project_Container';
export default function care_project_information()
{
    return (
...
care_project_information.getLayout = getLayout