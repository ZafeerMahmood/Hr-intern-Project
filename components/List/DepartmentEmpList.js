...
function DepartmentEmpList({value,link}) {
  return (
    ...
    <div className="each flex hover:shadow-lg select-none p-5 rounded-md border-gray-300 border mb-3 hover:border-gray-500 cursor-pointer">
        <div className="left">
            <div className="header text-gray-800 font-semibold text-2xl">{`${value[i][2]}`}</div>
            <div className="desc text-gray-600">{`${value[i][4]}`} </div>
        </div>
...
export default DepartmentEmpList